  ...
  return (
    <section className="relative flex flex-col items-center justify-center gap-6 text-center">
      <MotionDiv
        ...
        className="relative  p-[1px] shadow-lg overflow-hidden rounded-full bg-linear-to-r from-blue-500 via-blue-300 to-blue-500 animate-gradient-x group-hover:animate-gradient-y transition-all duration-200"
      >
        <Badge
          variant={"secondary"}
