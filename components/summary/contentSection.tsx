...
function EmojiPoint({ point }: { point: string }) {
  ...
  return (
    <div className="group p-4   relative bg-linear-to-br from-gray-200/[0.8] to-gray-400/[0.03] rounded-2xl border border-gray-500/10 hover:shadow-lg transition-all">
